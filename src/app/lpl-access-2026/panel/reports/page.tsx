...
function toActivityExportRow(log: AuditLogEntry) {
  return {
...
export default function AdminReportsPage() {
  ...
  // Exports every entry matching the active activity filters, across
  // every page - not just the 30 rows currently on screen (activityLogs
  // is paginated for browsing; an export of "this user's activity"
  // should mean their whole matching history).
  const getActivityExportRows = async () => {
    ...
    return all.map(toActivityExportRow);
  };
