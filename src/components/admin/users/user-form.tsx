...
export function UserForm({ user, locale, onSuccess }: UserFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: user 
          ? `${formData.name} a été mis à jour avec succès.`
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Informations essentielles du compte utilisateur.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-muted-foreground">
                    Cliquez sur l&apos;icône de téléchargement pour ajouter une photo de profil.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Ex: Journaliste sportif, Rédactrice économique
                  </p>
                </div>
                <div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-muted-foreground">
                  Cette biographie apparaîtra sur la page de l&apos;auteur.
                </p>
              </div>
              ...
              {!user && (
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-muted-foreground">
                    Minimum 8 caractères avec au moins un chiffre et un caractère spécial.
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="editor">Rédacteur - Peut publier et gérer</SelectItem>
                    <SelectItem value="writer">Auteur - Peut créer et modifier</SelectItem>
                    <SelectItem value="contributor">Contributeur - Peut soumettre uniquement</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Renforcer la sécurité du compte</p>
                </div>
                <Switch
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">{formData.totalArticles}</span>
                </div>
                <div className="flex items-center justify-between">
